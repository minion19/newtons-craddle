...
var bobObject1,bobObject2,bobObject3, bobObject4,bobObject5, rooff
...
function setup() {
	...
	world = engine.world;
	rooff=new roof(width/2,height/4,width/7,20);
	...
	rope1=new rope(bobObject1.body,rooff.body,-bobDiameter*2, 0)

	rope2=new rope(bobObject2.body,rooff.body,-bobDiameter*1, 0)
	rope3=new rope(bobObject3.body,rooff.body,0, 0)
	rope4=new rope(bobObject4.body,rooff.body,bobDiameter*1, 0)
	rope5=new rope(bobObject5.body,rooff.body,bobDiameter*2, 0)
	constraint1={
